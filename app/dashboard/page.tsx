                ...
                <main className="p-4 lg:p-8">
                    ...
                    <div>
                        ...
                        {loading ? (
                            ...
                            <div className="text-center py-12 px-4 bg-white border border-slate-100 rounded-xl">
                            ...
                            <div className="space-y-3">
                                {upcomingAssignments.map((assignment) => {
                                    ...
                                    return (
                                        <div key={assignment.id} className="bg-white border border-slate-100 rounded-xl p-4 hover:border-primary/30 transition-colors">
                                            <div className="flex items-start justify-between gap-4">
                                                ...
                                                <button
                                                    ...
                                                    className="flex-shrink-0 w-10 h-10 rounded-lg border border-slate-200 hover:border-primary hover:bg-primary hover:text-white text-slate-400 transition-colors flex items-center justify-center"
                                                >
