            ...
            <div className="lg:pl-64">
                ...
                <main className="p-4 lg:p-8 max-w-2xl mx-auto">
                    <div className="mb-8">
                        ...
                        <p className="text-slate-500 dark:text-slate-400 text-sm">Manage your preferences and account</p>
                    </div>

                    <div className="space-y-6">
                        {/* Account Section */}
                        <section className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-xl p-6">
                            ...
                            <button
                                onClick={handleLogout}
                                className="w-full sm:w-auto px-4 py-2 bg-red-50 dark:bg-red-900/10 text-red-600 dark:text-red-400 border border-red-100 dark:border-red-900/30 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/20 transition-colors font-medium text-sm flex items-center justify-center gap-2"
                            >
                                <span className="material-icons-outlined text-lg">logout</span>
                                Sign Out
                            </button>
                        ...
                        <section className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-xl p-6">
                            ...
                            <div className="flex items-center justify-between py-2">
                                <div>
                                    <p className="font-medium text-slate-900 dark:text-white">Assignment Reminders</p>
                                ...
                                <button
                                    ...
                                    disabled={isSaving}
                                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 ${emailNotifications ? 'bg-primary' : 'bg-slate-200 dark:bg-slate-700'
                                        }`}
                                >
                                    <span
                        ...
                        <section className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-xl p-6">
                            ...
                            <div className="space-y-3 text-sm text-slate-600 dark:text-slate-400">
                                <div className="flex justify-between">
                                    <span>Version</span>
                                    <span className="font-mono text-slate-900 dark:text-white">1.0.0</span>
                                </div>
                                <div className="flex justify-between">
                                    <span>Theme</span>
                                    <span className="text-slate-900 dark:text-white">System Default</span>
                                </div>
                                <div className="pt-2">
