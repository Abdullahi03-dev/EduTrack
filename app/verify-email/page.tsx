...
export default function VerifyEmailPage() {
    ...
    return (
        <div className="h-screen p-6 md:p-8 lg:p-8 flex items-center justify-center bg-white dark:bg-slate-950 font-display text-slate-900 dark:text-slate-50 antialiased selection:bg-primary/20">
            <div className="w-full max-w-md">
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 sm:p-8 shadow-sm">
                    ...
                    <div className="space-y-3">
                        ...
                        <button
                            ...
                            className="w-full bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-900 dark:text-white font-medium py-3 px-4 rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {resendLoading ? (
                ...
                <div className="mt-6 text-center space-y-3">
                    ...
                    <div>
                        <Link
                            href="/"
                            className="text-sm text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 transition-colors flex items-center justify-center gap-1"
                        >
