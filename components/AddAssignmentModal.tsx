...
export default function AddAssignmentModal({ isOpen, onClose, userId }: AddAssignmentModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const result = await addAssignment(
                ...
                dueDateObj,
                priority,
                description.trim() || undefined  // Pass description if provided
            );
            ...
            toast.error("An error occurred while adding assignment");
        } finally {
            setLoading(false);
        }
    };
